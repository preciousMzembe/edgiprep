              ...
              children: [
                ...
                IntrinsicHeight(
                  child: Row(
                    children: [
                      Expanded(
                        child: statBox("46", statTitleFontSize,
                            "Completed Quizzes", statSubtitleFontSize),
                      ),
                      SizedBox(
                        width: 30.w,
                      ),
                      Expanded(
                        child: statBox("3", statTitleFontSize,
                            "Completed Mock Exams", statSubtitleFontSize),
                      ),
                      SizedBox(
                        width: 30.w,
                      ),
                      Expanded(
                        child: statBox("7", statTitleFontSize,
                            "Completed Past Papers", statSubtitleFontSize),
                      ),
                    ],
                  ),
                ),
                  ...
                  onTap: () async {
                    await showDialog(
                      ...
                      builder: (BuildContext context) {
                        return UnenrollSubjectContent(subject: subject);
                      },
                    );

                    bool enrolled = await enrollmentSettingsController
                        .checkSubjectEnrollment(subject.id);
